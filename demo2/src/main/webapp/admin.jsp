...
<head>
    ...
    <style>
        ...
        .menu-section, .dish-section, .stats-section {
            width: 45%;
            padding: 20px;
...
<div class="menu-section">
    ...
    <c:forEach var="dish" items="${dishes}">
        <div class="dish-info">
            ...
            <p><strong>Availability:</strong> ${dish.getIsAvailable()}</p>
...
<div class="dish-section form-container">
    ...
    <form action="${pageContext.request.contextPath}/admin/deleteReviews" method="post">
        <button type="submit">Delete Reviews</button>
    </form>
...
<div class="stats-section">
    <h2>Statistics</h2>
    <p><strong>Total Number of Orders:</strong> ${totalNumberOfOrders}</p>
    <p>${sqlError2}</p>
</div>

<div class="stats-section">
    <h2>Average Ratings for Dishes</h2>
    <c:forEach var="entry" items="${averageRatingForEachDish}">
        <p><strong>Dish ID ${entry.key}:</strong> Average Rating: ${entry.value}</p>
    </c:forEach>
    <p>${sqlError3}</p>
</div>
</body>
